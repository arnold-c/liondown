...
Under the hood, the Penn State University LaTeX template is used to
...
## Customizing thesisdown/liondown to your institution

For an up-to-date list of forks of the `{thesisdown}` project, click on
[this
link](https://github.com/ismayc/thesisdown#customizing-thesisdown-to-your-institution).

These are the steps I took to adapt `{thesisdown}`:

### Using thesisdown/liondown

> The following instructions are from `{thesisdown}`
