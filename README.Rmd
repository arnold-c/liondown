...
This project provides a [bookdown](https://github.com/rstudio/bookdown) template
for theses at Penn State University, and is an adaptation of Chester Ismay's
excellent [`{thesisdown}`](https://github.com/ismayc/thesisdown) package. I am
currently using Dr Gary L. Gray's Latex template and class files, from the 
Department of Engineering, which can be found 
...
Under the hood, the Penn State University LaTeX template is used to ensure that
...
[this link](https://github.com/ismayc/thesisdown#customizing-thesisdown-to-your-institution).
